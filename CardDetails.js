...
import { Container, Card,Item, Content, CardItem, Button,View, Left,  Body,  Text, Spinner , Form, FooterTab, Tab, Tabs, TabHeading} from 'native-base';
            ...
            <Container>
              <MyHeader title={ this.props.navigation.getParam('title')}/>
                ...
                <Tabs  tabStyle={{color:'white'}}>
                          ...
                          <Card style={{borderRadius:10}}>
                              ...
                              <CardItem >
                                <Body>
                                  ...
                                  <Text style={{color:'green' , fontSize:24,fontWeight:'bold',paddingLeft:'4%' ,margin:'2%'}}>
                                  More Information
                                  </Text>
                    ...
                    >
                            <WebView
                                source={{uri: this.props.navigation.getParam('maploc')}}
